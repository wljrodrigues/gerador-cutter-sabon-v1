...
<script type="text/JavaScript">
   ...
   <!-- <h3>Gerar Cutter</h3> -->
    ...
    <form>
            ...
            <input type="text" class="form-control cutter-nome" type="text" name="nomeAutor" placeholder="Por exemplo: Rodrigues, Walter"/>

            <button class="btn btn-primary cutter-gera" type="submit"  onclick="submitCut()"><?php _e( 'Gerar código Cutter', 'cutter-sanborn' );?></button>
    ...
    <div class="cutter-footer">
        <a href="<?php echo plugin_dir_url( __FILE__ );?>about.html" target="_blank" class="card-link"><?php _e( 'Como usar o Gerador de Cutter', 'cutter-sanborn' );?></a> | 
       <a href="https://editoraitacaiunas.com.br" target="_blank" class="card-link"><?php _e( 'Editora Itacaiúnas', 'cutter-sanborn' );?></a>
...
<script type="text/javascript">
  ...
  $temp.remove();
     alert("Cutter copiado. Anote aí: " + $(element).text());
}
